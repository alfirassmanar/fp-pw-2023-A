...
>
  <head>
    ...
    <title>Mahasiswa Tidak diTerima - Admin</title>
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="../admin/vAdmin.php">Home</a>  /</span> Acc non Mahasiswa</h4>
              <a href="./vExportDitolak.php"><div class="btn btn-sm btn-success" style="margin-bottom: 10px;">Export PDF</div></a>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Tabel non Acc Mahasiswa</h5>
