...
$nMahasiswa = mysqli_query($conn,"SELECT * FROM vHasilPendaftaran WHERE status_registrasi = 0 limit 7");
...
data: {
datasets: [{
data:<?php echo json_encode($outTotalStatus);
